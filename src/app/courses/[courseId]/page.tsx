...
const courseData: { [key: string]: any } = {
  'Quantum Physics Explained': {
    ...
    subTopics: [
      { id: '1', title: 'Introduction to Quantum States', videoId: 'Y2U_o-3A4pA', duration: '10:32', transcript: 'A quantum state is a mathematical entity that provides a probability distribution for the outcomes of each possible measurement on a system.' },
