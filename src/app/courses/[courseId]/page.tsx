...
const courseData: { [key: string]: any } = {
  'Quantum Physics Explained': {
    ...
    subTopics: [
      ...
      { id: '2', title: 'Wave-Particle Duality', videoId: '1TnsyYMYjMo', duration: '12:45', transcript: 'Wave-particle duality is the concept in quantum mechanics that every particle or quantum entity may be described as either a particle or a wave.' },
